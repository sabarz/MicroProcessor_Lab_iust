...
_image_code:
	.DB  0xFF,0xFD,0x0,0xFF,0xFF,0xFF,0xF0,0xF7
	.DB  0xF7,0xF7,0x0,0xFF,0xFF,0xC1,0xBE,0xBE
	.DB  0xBE,0xC1,0xFF,0xFF,0xB6,0xB6,0xB6,0xB6
	.DB  0xC9,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF
...
; 0000 0047 //DDRC=(1<<DDC7) | (1<<DDC6) | (1<<DDC5) | (1<<DDC4) | (1<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
...
; 0000 0050 
; 0000 0051 DDRA=(0<<DDA7) | (1<<DDA6) | (1<<DDA5) | (1<<DDA4) | (1<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(127)
	OUT  0x1A,R30
; 0000 0052 // State: Bit7=T Bit6=0 Bit5=0 Bit4=0 Bit3=0 Bit2=0 Bit1=0 Bit0=0
; 0000 0053 PORTA=(0<<PORTA7) | (0<<PORTA6) | (0<<PORTA5) | (0<<PORTA4) | (0<<PORTA3) | (0<<PORTA2) | (0<<PORTA1) | (0<<PORTA0);
	LDI  R30,LOW(0)
	OUT  0x1B,R30
; 0000 0054 
; 0000 0055 // Port B initialization
; 0000 0056 // Function: Bit7=Out Bit6=Out Bit5=Out Bit4=Out Bit3=Out Bit2=In Bit1=In Bit0=In
; 0000 0057 DDRB=(1<<DDB7) | (1<<DDB6) | (1<<DDB5) | (1<<DDB4) | (1<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(248)
	OUT  0x17,R30
; 0000 0058 // State: Bit7=0 Bit6=0 Bit5=0 Bit4=0 Bit3=0 Bit2=T Bit1=T Bit0=T
...
_0x3:
; 0000 005D       {
; 0000 005E       unsigned int i, offset = 18;
; 0000 005F       for (; offset < 18 + 35; offset++) {
	SBIW R28,4
	LDI  R30,LOW(18)
	ST   Y,R30
	LDI  R30,LOW(0)
...
_0x7:
	...
	BRLO PC+2
	RJMP _0x8
; 0000 0060             int repeat = 0;
; 0000 0061             for (; repeat < 5; repeat++) {
	SBIW R28,2
	LDI  R30,LOW(0)
	ST   Y,R30
	STD  Y+1,R30
...
_0xA:
	...
	SBIW R26,5
	BRGE _0xB
; 0000 0062                 unsigned long scan = 1<<8;
; 0000 0063                 for (i = 0; i < 7; i++) {
	SBIW R28,4
	LDI  R30,LOW(0)
	ST   Y,R30
	LDI  R30,LOW(1)
...
_0xD:
	...
	SBIW R26,7
	BRSH _0xE
; 0000 0064                     PORTB = scan & 0xff;
	LD   R30,Y
	OUT  0x18,R30
; 0000 0065                     PORTA = image_code[(offset + i) % 35];
	LDD  R30,Y+8
	LDD  R31,Y+8+1
	LDD  R26,Y+6
	LDD  R27,Y+6+1
