...
; 0000 0012     SECOND_ONES += 1;
	RCALL SUBOPT_0x0
	ADIW R30,1
	STS  _SECOND_ONES,R30
	STS  _SECOND_ONES+1,R31
; 0000 0013 
...
_0x5:
	LDS  R26,_SECOND_ONES
	LDS  R27,_SECOND_ONES+1
	SBIW R26,10
	BREQ PC+2
	RJMP _0x6
...
; 0000 004E     PORTC = convert[HOUR_TENS];
	LDI  R26,LOW(_convert)
	LDI  R27,HIGH(_convert)
	ADD  R26,R4
	ADC  R27,R5
	RCALL SUBOPT_0x1
...
; 0000 0062     PORTC = convert[SECOND_ONES] | DP;
	RCALL SUBOPT_0x0
	SUBI R30,LOW(-_convert)
	SBCI R31,HIGH(-_convert)
	LD   R30,Z
	LDS  R26,_DP
	OR   R30,R26
	OUT  0x15,R30
...
SUBOPT_0x0:
	LDS  R30,_SECOND_ONES
	LDS  R31,_SECOND_ONES+1
	RET
