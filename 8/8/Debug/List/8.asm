...
_main:
; .FSTART _main
; 0000 002B     unsigned char key_res;
; 0000 002C     DDRC = 0xFF;
;	key_res -> R17
	LDI  R30,LOW(255)
	OUT  0x14,R30
...
; 0000 0031     lcd_clear();
	RCALL _lcd_clear
; 0000 0032     lcd_gotoxy(1, 0);
	LDI  R30,LOW(1)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 0033     lcd_puts("KEYPAD AND LCD");
	__POINTW2MN _0x3,0
	RCALL _lcd_puts
...
; 0000 003A         key_res = keypad_scan();
	...
	MOV  R17,R30
; 0000 003B 
; 0000 003C         if (key_res != 255) {
	CPI  R17,255
	BRNE PC+2
	RJMP _0x7
; 0000 003D             while (keypad_scan() != 255);
_0x8:
	RCALL _keypad_scan
	CPI  R30,LOW(0xFF)
	BRNE _0x8
; 0000 003E             delay_ms(20);
	...
	CALL _delay_ms
; 0000 003F 
; 0000 0040             if (key_res == KEYPAD_DIV) {
	CPI  R17,10
	BRNE _0xB
...
; 0000 0044             }
; 0000 0045 
; 0000 0046             else if (key_res == KEYPAD_MUL) {
	RJMP _0xC
_0xB:
	CPI  R17,11
	BRNE _0xD
...
; 0000 0050             }
; 0000 0051 
; 0000 0052             else if (key_res == KEYPAD_PLS) {
	RJMP _0x10
_0xF:
	CPI  R17,12
	BRNE _0x11
...
; 0000 0056             }
; 0000 0057 
; 0000 0058             else if (key_res == KEYPAD_EQU) {
	RJMP _0x12
_0x11:
	CPI  R17,14
	BRNE _0x13
; 0000 0059                 lcd_putchar('=');
	...
	RCALL _lcd_putchar
; 0000 005A 
; 0000 005B                 if (operator == '%')
	LDI  R30,LOW(37)
	CP   R30,R5
	BRNE _0x14
; 0000 005C                     number[2] = number[0] / number[1];
	CALL SUBOPT_0x1
	CALL __DIVF21
	RJMP _0x5B
; 0000 005D                 else if (operator == '*')
_0x14:
	LDI  R30,LOW(42)
	CP   R30,R5
	BRNE _0x16
; 0000 005E                     number[2] = number[0] * number[1];
	CALL SUBOPT_0x1
	CALL __MULF12
	RJMP _0x5B
; 0000 005F                 else if(operator == '-')
_0x16:
	LDI  R30,LOW(45)
	CP   R30,R5
	BRNE _0x18
; 0000 0060                     number[2] = number[0] - number[1];
	CALL SUBOPT_0x1
	CALL SUBOPT_0x2
	RJMP _0x5B
...
_0x18:
	...
	CP   R30,R5
	BRNE _0x1A
; 0000 0062                     number[2] = number[0] + number[1];
	CALL SUBOPT_0x1
	CALL __ADDF12
_0x5B:
	__PUTD1MN _number,8
; 0000 0063 
; 0000 0064                 ftoa(number[2], 2, out_text);
_0x1A:
	__GETD1MN _number,8
	CALL __PUTPARD1
	LDI  R30,LOW(2)
...
; 0000 0066             }
; 0000 0067 
; 0000 0068             else if (key_res == KEYPAD_ON) {
	RJMP _0x1B
_0x13:
	CPI  R17,15
	BRNE _0x1C
...
; 0000 006A                 lcd_gotoxy(0, 0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 006B                 number[2] = 0;
	__POINTW1MN _number,8
	CALL SUBOPT_0x3
; 0000 006C                 number[1] = 0;
	__POINTW1MN _number,4
	CALL SUBOPT_0x3
; 0000 006D                 number[0] = 0;
	LDI  R30,LOW(0)
	STS  _number,R30
	STS  _number+1,R30
	STS  _number+2,R30
...
; 0000 0075                 number[counter] *= 10;
	...
	POP  R27
	CALL __PUTDP1
; 0000 0076                 number[counter] += key_res;
	CALL SUBOPT_0x4
	PUSH R31
	PUSH R30
	MOVW R26,R30
...
; 0000 007F 
; 0000 0080     ////////////////////////  ROW1 ////////////////////////
; 0000 0081     KEYPAD_R1 = 1;
	ST   -Y,R17
;	result -> R17
	LDI  R17,255
	SBI  0x12,0
; 0000 0082     KEYPAD_R2 = 0;
	CBI  0x12,1
...
_0x29:
	SBIS 0x10,6
	RJMP _0x2B
; 0000 008C         result = KEYPAD_NUM9;
	LDI  R17,LOW(9)
; 0000 008D     else if (KEYPAD_C4)
	RJMP _0x2C
_0x2B:
	SBIC 0x10,7
; 0000 008E         result = KEYPAD_DIV;
	LDI  R17,LOW(10)
; 0000 008F 
; 0000 0090     ////////////////////////  ROW2 ////////////////////////
; 0000 0091     KEYPAD_R1 = 0;
_0x2C:
_0x2A:
_0x28:
	CBI  0x12,0
; 0000 0092     KEYPAD_R2 = 1;
	SBI  0x12,1
; 0000 0093     KEYPAD_R3 = 0;
	CALL SUBOPT_0x6
; 0000 0094     KEYPAD_R4 = 0;
; 0000 0095 
; 0000 0096     delay_ms(5);
; 0000 0097     if (KEYPAD_C1)
	SBIS 0x10,4
	RJMP _0x36
; 0000 0098         result = KEYPAD_NUM4;
	LDI  R17,LOW(4)
...
_0x38:
	SBIS 0x10,6
	RJMP _0x3A
; 0000 009C         result = KEYPAD_NUM6;
	LDI  R17,LOW(6)
; 0000 009D     else if (KEYPAD_C4)
	RJMP _0x3B
_0x3A:
	SBIC 0x10,7
; 0000 009E         result = KEYPAD_MUL;
	LDI  R17,LOW(11)
; 0000 009F 
; 0000 00A0     ////////////////////////  ROW3 ////////////////////////
; 0000 00A1     KEYPAD_R1 = 0;
_0x3B:
_0x39:
_0x37:
	CBI  0x12,0
; 0000 00A2     KEYPAD_R2 = 0;
	CBI  0x12,1
; 0000 00A3     KEYPAD_R3 = 1;
	SBI  0x12,2
; 0000 00A4     KEYPAD_R4 = 0;
	CBI  0x12,3
; 0000 00A5 
...
_0x47:
	SBIS 0x10,6
	RJMP _0x49
; 0000 00AC         result = KEYPAD_NUM3;
	LDI  R17,LOW(3)
; 0000 00AD     else if (KEYPAD_C4)
	RJMP _0x4A
_0x49:
	SBIC 0x10,7
; 0000 00AE         result = KEYPAD_MNS;
	LDI  R17,LOW(13)
; 0000 00AF 
; 0000 00B0     ////////////////////////  ROW4 ////////////////////////
; 0000 00B1     KEYPAD_R1 = 0;
_0x4A:
_0x48:
_0x46:
	CBI  0x12,0
; 0000 00B2     KEYPAD_R2 = 0;
	CBI  0x12,1
; 0000 00B3     KEYPAD_R3 = 0;
	CBI  0x12,2
; 0000 00B4     KEYPAD_R4 = 1;
	SBI  0x12,3
; 0000 00B5 
